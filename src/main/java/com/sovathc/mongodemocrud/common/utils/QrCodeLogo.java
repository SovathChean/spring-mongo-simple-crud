...
public class QrCodeLogo {
    private final String DIR = "./src/main/resources/static/img/";
    private final String ext = ".png";
    private final String LOGO = "https://d3acsj8nrl7kd.cloudfront.net/market/dev-mkt/temporary/user/135/invoice-6ad1be43-cbbf-414c-886c-be5d22ed910a.png";
    private final String CONTENT = "image/png";
    ...
    public void generate() {
        ...
        try {
            ...
            bitMatrix = writer.encode("https://aboullaite.me/generate-qrcode-with-logo-image-using-zxing/", BarcodeFormat.QR_CODE, WIDTH, HEIGHT, hints);
    ...
    private MatrixToImageConfig getMatrixConfig() {
        // ARGB Colors
        // Check Colors ENUM
        return new MatrixToImageConfig(QrCodeLogo.Colors.WHITE.getArgb(), QrCodeLogo.Colors.ORANGE.getArgb());
    }
